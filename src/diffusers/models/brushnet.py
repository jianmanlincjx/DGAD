...
class BrushNetModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        mid_block_type: Optional[str] = "MidBlock2D",
    ...
    def from_unet(
        ...
        if load_weights_from_unet:
            ...
            conv_in_condition_weight[:,8:12,...]=unet.conv_in.weight
...
class BrushNetModel_mirror_unet(ModelMixin, ConfigMixin):
    """
    A BrushNet model.
    ...
    def from_unet(
        ...
        if load_weights_from_unet:
            ...
            brushnet.down_blocks.load_state_dict(unet.down_blocks.state_dict(),strict=False)
            brushnet.mid_block.load_state_dict(unet.mid_block.state_dict(),strict=True)
            brushnet.up_blocks.load_state_dict(unet.up_blocks.state_dict(),strict=True)
