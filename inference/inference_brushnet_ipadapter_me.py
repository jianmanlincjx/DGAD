...
if __name__ == "__main__":
    ...
    linpro_path = '/data1/JM/code/BrushNet-main/exp/insert_brushnet_ipadapter/checkpoint-10000/image_proj/pytorch_model.bin'
    ip_adapter_path = '/data1/JM/code/BrushNet-main/exp/insert_brushnet_ipadapter/checkpoint-10000/adapter/pytorch_model.bin'
    ...
    output_folder = '/data1/JM/code/BrushNet-main/datasets/MSRA-10K_result_with_prompt_me'
